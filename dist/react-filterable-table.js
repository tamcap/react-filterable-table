		...
		_createClass(Header, [{
			...
			value: function render() {
				...
				var perPageSelect = this.props.pagersVisible !== false && this.props.pageSizes && this.props.pageSizes.length > 0 ? _react2.default.createElement(
					'select',
					{ className: 'form-control float-right', onChange: updatePageSize, value: this.props.pageSize },
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-5 order-sm-5' },
							perPageSelect
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-4 order-sm-4 text-center text-muted record-count' },
